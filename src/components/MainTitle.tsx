...
const MainTitle = React.forwardRef<HTMLDivElement, MainTitleProps>(({ className, title, subtitle, ...props }, ref) => {
	const id = React.useId();

	return (
		<div id={id} ref={ref} className={cn("flex flex-col gap-2 items-center", className)} {...props}>
